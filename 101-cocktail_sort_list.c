...
/**
 * swap_node_ahead - The function swap a node in a listint_t doubly-linked
...
/**
 * swap_node_behind - The swap a node in a listint_t doubly-linked
...
/**
 * cocktail_sort_list - The function sorts a doubly linked list of integers
